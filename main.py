import sys
import qrcode
from node_modules.dotenv import load_dotenv
import logging.config
from pathlib import Path
import os
import argparse
from datetime import datetime
from node_modules import validators  # Import the validators package
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/NJIT-NSD')
